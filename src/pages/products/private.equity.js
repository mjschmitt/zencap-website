// src/pages/products/private-equity.js
  ...
  return (
    <Layout>
      <SEO
        ...
        description="Excel-based financial models for private equity investments, including multi-family, office, and other commercial real estate assets."
