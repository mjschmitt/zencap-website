            ...
            <Motion animation="fade" direction="up" delay={200}>
              <div className="bg-white dark:bg-navy-800 rounded-lg shadow-md overflow-hidden h-full flex flex-col">
                ...
                <div className="p-8 flex-grow flex flex-col">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Before his Wall Street career, Max underwrote and managed over $1 billion in commercial real estate transactions across office, industrial, and multifamily sectors. This unique combination of public markets expertise and private equity experience enables Zenith to deliver institutional-grade analytical solutions that bridge theory and practice. Max holds a Bachelor of Science in Finance and dual Master&apos;s degrees in Entrepreneurship and Real Estate from the University of Florida, and passed the CFA Level 1 exam in the 90th percentile.
                  </p>
